...
| **Objectives per level** | **L0**: pull 3 breakers (sparking, beaconed). **L1**: find 3 fuel canisters and *carry* them to THE GENERATOR — the fuel sloshes, and it hears carriers; `G` sets it down. **THE POOLROOMS**: two drain valves held *simultaneously*, far apart, on the level where it's fastest. Power up → the exit opens → it stops being patient. |
| **Noise** | Sprinting, wading, carrying fuel — it can hear all of it and prefers loud targets. Walking quietly is a real tactic. |
| **The bodies** | Die, and your corpse — name scrawled beside it — is still findable next round, in the new maze. The backrooms keep what they take. |
